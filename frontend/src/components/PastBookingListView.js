            ...
            .then(res => {
                for (var i in res.data) {
                    if (res.data[i]["admin_did_accept"]) {
                        ...
                        res.data[i]["is_pending"] = (<Tooltip title="Request Accepted" color="green">
                            <CloseCircleTwoTone twoToneColor="green" /></Tooltip>);
                    } else if (res.data[i]["is_pending"]) {
                        res.data[i]["admin_did_accept"] = (<Tooltip title="Request in Queue" color="gray">
                            <LoadingOutlined /></Tooltip>);
                        ...
                        res.data[i]["is_pending"] = (<Tooltip title="Request Denied" color="red">
                            <CloseCircleTwoTone twoToneColor="red" /></Tooltip>);
                    }
